...
<section id="dashboard-analytics">
  @include('panels.flash')
      <div class="col-lg-12 col-sm-12 col-12">
        <button id="btn-add" class="dt-button add-new btn btn-primary mb-2"  aria-controls="DataTables_Table_0" type="button" data-bs-toggle="modal" data-bs-target="#modals-slide-in"><span>Buat Keluhan Baru</span></button>
        <div class="card">
          <div class="card-header bg-light-primary flex-column align-items-start">
            <div class="row col-12">
                ...
                <div class="col-lg-11 col-10 my-auto">
                    <p class="h4 card-text">Daftar Keluhan Yang Dibuat</p>
                </div>
            </div>
          </div>
          <div class="card-body" >
      ...
      <div class="modal modal-slide-in new-user-modal fade" id="modals-slide-in">
        <div class="modal-dialog">
          <form class="add-new-user modal-content pt-0" method="POST" action="{{route('keluhan-add-user')}}">
            @csrf
            ...
            <div class="modal-body flex-grow-1">
              ...
              <div class="mb-1">
                <label class="form-label" for="basic-icon-default-isi">Isi</label>
                <textarea
                  type="text"
