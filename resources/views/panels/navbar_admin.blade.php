...
<div class="navbar-container d-flex content">
  <div class="bookmark-wrapper d-flex align-items-center">
    ...
    <ul class="nav navbar-nav bookmark-icons">
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('dashboard-admin') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Informasi"><i class="ficon"
            data-feather="info"></i> Informasi</a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('kegiatan-admin') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Kegiatan"><i class="ficon"
            data-feather="activity"></i> Kegiatan</a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('pengunduran-admin') }}"
      ...
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('anggota-admin') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Data Anggota"><i class="ficon"
            data-feather="users"></i> Data Anggota</a></li>
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('keluhan-admin') }}"
